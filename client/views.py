    ...
    if request.method == POST:
        ...
        if not params_check['failed']:
            ...
            if result['status'] == POSITIVE:
                request.session['client_id'] = result['client'].pk
                request.session['client_name'] = { 'first_name': result['client'].first_name, 'last_name': result['client'].last_name, 'middle_name': result['client'].middle_name }
                request.session['client_email'] = result['client'].email
